...
const DEFAULT_FIELDS =
  'createdAt,updatedAt,trackedEntity,trackedEntityType,orgUnit,orgUnitName,attributes[attribute,code,valueType,value],enrollments[enrollment,enrolledAt,occurredAt,program,status,orgUnit,storedBy,attributes[attribute,code,valueType,value],events[event,occurredAt,dueDate,scheduledAt,status,programStage,program,trackedEntity,enrollment,orgUnit,orgUnitName,assignedUser,storedBy,dataValues[dataElement,value]]],relationships[relationship,relationshipType,from[trackedEntity[trackedEntity]],to[trackedEntity[trackedEntity]]';
