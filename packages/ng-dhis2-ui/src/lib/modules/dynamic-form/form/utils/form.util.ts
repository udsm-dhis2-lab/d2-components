...
import { Field } from '../../form-models/models';
import { FieldUtil } from '../../form-models/utils';
...
export class FormUtil {
  ...
  static getFormFields(fields: any[]): Field<string>[] {
  ...
  static createField(
    ...
    label: string,
    required: boolean,
    controlType: 'textbox' | 'dropdown' | 'textarea' | 'transfer' | 'search' | 'file',
    disabled?: boolean,
    placeholder?: string,
    options?: Array<any>,
  ): Field<string> {
