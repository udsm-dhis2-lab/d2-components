...
type ComponentWithCustomControls = TrackerFormComponent; // & {};
...
const meta: Meta<ComponentWithCustomControls> = {
  ...
  // title: 'Components/Tracker Form',
  component: TrackerFormComponent,
  // decorators: [moduleMetadata({ imports: [] }), applicationConfig({ providers: [ importProvidersFrom() ]})],
  parameters: {
    docs: { description: { component: `TrackerForm` } },
    // layout: 'fullscreen',
  },
  argTypes: {
    /** === Input Mapping === */
...
export const TrackerForm: StoryObj<ComponentWithCustomControls> = {
